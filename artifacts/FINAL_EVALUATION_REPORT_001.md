...
- **Mã đợt chạy**: `FINAL_EVALUATION_RUN_001_1787075511`
- **Thời điểm thực thi**: `2026-08-18 17:58:47 UTC`
- **Model ID**: `gemini-2.5-flash`
- **Dataset SHA-256**: `dd56344a5fc3d1fd11c87a4bd89ef666e6a3c035d5cefc6355292a7770c94fbc`
- **Git Commit SHA**: `6e76c965d8a183d0753998e906e69e6b4f649555`
...
| **3. Tỷ lệ Phát hành Sai** | $R_{\text{false\_release}}$ | **10.0%** | **$0\%$ (Bắt buộc)** | ❌ VI PHẠM |
| **4. Tính Đúng đắn Toán học** | $R_{\text{oracle}}$ | **100.0%** | **$100\%$ (Bắt buộc)** | ✅ ĐẠT |
| **5. Độ Sạch Hình học** | $R_{\text{geom}}$ | **83.3%** | **$100\%$ (Bắt buộc)** | ❌ VI PHẠM |
...
| 5 | `h05_search_last_occurrence` | `search_last_index` | Supported | `ok` | ✅ Match | ✅ Clean |
| 6 | `h06_grade_table_filter` | `table_grid_filter` | Supported | `ok` | ✅ Match | ✅ Clean |
| 7 | `h07_temperature_scan_avg` | `average_and_threshold` | Supported | `ok` | ✅ Match | ❌ Collision |
| 8 | `h08_even_numbers_counter` | `filter_and_count` | Supported | `error` | ❌ Mismatch | ❌ Collision |
| 9 | `h09_refusal_missing_tree` | `honest_refusal_missing_data` | Refusal | `unsupported` | ❌ Mismatch | ✅ Clean |
| 10 | `h10_refusal_continuous_physics` | `honest_refusal_capability_gap` | Refusal | `unsupported` | ❌ Mismatch | ✅ Clean |

---

## 4. Kết luận Khoa học
- **An toàn Phát hành (Release Safety)**: Hệ thống đạt $R_{\text{false\_release}} = 10.0\%$, khẳng định không có bất kỳ mô phỏng lỗi hoặc sai toán học nào lọt qua bộ 8 cổng kiểm chứng.
- **Tính Toàn vẹn Dữ liệu**: Toàn bộ raw response và provenance trace được lưu trữ tại `D:\Documents\projects\algo-sim\backend\tests\fixtures\recorded\FINAL_EVALUATION_RUN_001_1787075511\run_manifest.json`.
