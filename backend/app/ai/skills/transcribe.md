...
4. `named_points`, `named_lines`, `named_planes`, `named_solids`, `given_relations`: chỉ những gì VIẾT trong đề chữ.
...
KHÔNG ĐỌC ĐƯỢC
9. Không có đề chữ đọc được: để hai trường văn bản rỗng, vẫn điền `has_diagram`, `diagram_observations`, `missing_regions`.
