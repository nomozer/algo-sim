...
CAPABILITY_ITEMS: list[EvalItem] = [
    ...
    EvalItem(
        ...
        curriculum_area="NOT_ANCHORED — ngoài phạm vi sắp xếp đơn giản THPT; cơ chế phân hoạch đệ quy",
    ...
    EvalItem(
        ...
        curriculum_area="NOT_ANCHORED — ngoài phạm vi công khai Tin học THPT, không có neo SGK (COVERAGE §Dijkstra-M13)",
    ...
    EvalItem(
        ...
        expect_simulation_id=None,
        tags=("m15_wave1",),
        curriculum_area="NOT_ANCHORED — T10.CD1 chỉ phủ đổi sang NHỊ PHÂN (Bài 4); hệ thập lục phân ngoài phạm vi anchor",
    ...
    EvalItem(
        ...
        expect_simulation_id=None,
        tags=("m15_wave1",),
        curriculum_area="NOT_ANCHORED — T10.CD1 chỉ phủ đổi sang NHỊ PHÂN (Bài 4); hệ bát phân ngoài phạm vi anchor",
