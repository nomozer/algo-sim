...
ALLOWED_CANONICAL_ACTIONS = [
    ...
    "SECOND_FAMILY_LIVE_SCHEMA_REVALIDATION_PREREGISTRATION",
    "SECOND_FAMILY_LIVE_RETRY_PREREGISTRATION",
    "SECOND_FAMILY_LIVE_RETRY",
    "PRISM_VERTICAL_SLICE_MERGE_READINESS_REVIEW",
    "PUSH_FEATURE_BRANCH_AND_OPEN_PR",
    "PRISM_MERGE_READINESS_EVIDENCE_IDENTITY_RECONCILIATION_OFFLINE",
    "REFRESH_REMOTE_MAIN_AND_REVALIDATE_MERGE_BASE",
