...
Cập nhật lần cuối: sau **M9-UX6** — tuân thủ DESIGN.md (sticker palette là trang trí) + guard vệ sinh quét mã nguồn.
...
| vitest | **293 pass** (0 network call; +12 M9-UX5 · +5 M9-UX6: ui-hygiene quét mã nguồn + luật DESIGN.md) |
