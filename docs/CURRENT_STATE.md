...
| | |
|---|---|
| pytest | **335 pass** (0 API call thật — guard là bằng chứng; +18 do M12-AI-SCAN: scan_engine 10 + routing 8) |
| vitest | **359 pass** (0 network call; +9 do M12-AI-SCAN: pseudocode dẫn xuất 4 + module scan 5) |
