...
Cập nhật lần cuối: sau **M9-UX2** — onboarding trực quan + workspace simulation-first + vệ sinh phạm vi luận văn.
...
| vitest | **269 pass** (0 network call; +10 M9-UX2: catalog/visibility/preview) |
