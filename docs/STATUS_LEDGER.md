...
| Độ ổn định tổng hợp trên bộ V2 (k=3) | **SẴN SÀNG CHẠY** | Hạt giống đã đủ; lượt sau cần 0 analyze + 6 R2 + 6 R3 + 0 sửa, và phải khẳng định `MODEL_INPUT_HASH` khớp R1 trước khi gửi. ~~chặn bởi artifact~~ | chưa xếp |
