...
| Ngữ nghĩa tương tác 23 target | **6 / 9 / 3 / 5** | `INTERACTIVE_MODEL` 6 (đụng ĐỐI TƯỢNG HỌC) · `BOUNDED_PARAMETER_TOOL` 9 (chỉ đổi ĐẦU VÀO) · `TRACE_MODEL` 3 · `PROBE_LIMITED` 5. Con số giảm so với lượt trước và đó là kết quả TRUNG THỰC HƠN | **W12 tiếp** |
