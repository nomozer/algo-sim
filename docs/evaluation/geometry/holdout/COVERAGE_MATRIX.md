...
| **A11** | ≥1 | `rational_distance` | `exact_fraction` → `distance` | ① ② ③a ③b ⑤ | ⛔ SOURCE_GAP — tìm theo CHỮ KÝ PYTHAGORE (3–4, 6–8, 5–12); xem HOLDOUT_ACQUISITION_LOG §7 | 0 | ⛔ chưa có bài | người mở nguồn, chép nguyên văn, ký · **CHỈ `distance` hữu tỉ** (chốt 2026-08-28). Bài mà khoảng cách ra vô tỉ thì LOẠI, không chuyển sang ô tầng B — số ô giữ nguyên 20. |
