...
const NGUON = resolve(
  new URL("../../docs/evaluation/geometry/clean-baseline-v2/spot-envelopes.json",
    import.meta.url).pathname.replace(/^[/]/, ""));
const OUT = resolve(
  new URL("../../docs/evaluation/geometry/clean-baseline-v2/spot-check.json",
    import.meta.url).pathname.replace(/^[/]/, ""));
...
console.log(`━━ SPOT CHECK ${cases.length} cảnh · CLEAN_BASELINE_V2 ━━`);
