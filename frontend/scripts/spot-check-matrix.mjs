...
const NGUON = resolve(
  new URL("../../docs/evaluation/geometry/generalization-matrix/spot-envelopes.json",
    import.meta.url).pathname.replace(/^[/]/, ""));
const OUT = resolve(
  new URL("../../docs/evaluation/geometry/generalization-matrix/spot-check.json",
    import.meta.url).pathname.replace(/^[/]/, ""));
...
console.log(`━━ SPOT CHECK ${cases.length} cảnh do AI sinh ━━`);
