...
const NGUON = resolve(
  new URL("../../docs/evaluation/geometry/translation-probe/spot-envelopes.json",
    import.meta.url).pathname.replace(/^[/]/, ""));
const OUT = resolve(
  new URL("../../docs/evaluation/geometry/translation-probe/spot-check.json",
    import.meta.url).pathname.replace(/^[/]/, ""));
...
console.log(`━━ SPOT CHECK ${cases.length} cảnh · TRANSLATION_PROBE ━━`);
