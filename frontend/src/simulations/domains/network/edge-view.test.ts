...
/* W4B-2R — KHỐI PARITY BẢNG MÀU 3D ĐÃ NGHỈ CÙNG RENDERER.
   `packet_routing` nay là 2D_ONLY (module tự khai `architectural_poc`: Z chỉ là
   bố cục), nên `ROUTE_EDGE_COLOR_3D` không còn tồn tại. Từ vựng `EdgeStatus` vẫn
   được khoá đầy đủ ở các khối trên — nó là ngữ nghĩa cạnh, không phải chuyện 3D.
   Parity 2D↔3D thật sự nay do `network.protocol_encapsulation` làm chứng
   (`encap-render3d.test.tsx`, `render-parity.test.tsx`). */
